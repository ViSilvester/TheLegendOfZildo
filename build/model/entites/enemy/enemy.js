...
export class Enemy extends Entity {
    constructor(sprite, pos, life, attack, defence, magic, inteligence) {
        super();
        this.pos = pos;
    ...
    render(game) {
        ...
        game.draw.drawImage(this.sprite, new Vec2(((this.pos.x - offset.x) * game.tilesize) + game.globalPos.x, ((this.pos.y - offset.y) * game.tilesize) + game.globalPos.y), new Vec2(game.tilesize, game.tilesize), new Vec2(x * 16, 0), new Vec2(16, 16));
    }
    calcAttackDamage(player) {
        if (Math.random() > 0.05) {
