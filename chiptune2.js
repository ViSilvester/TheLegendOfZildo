import { Module, UTF8ToString, writeAsciiToMemory } from "./libopenmpt.js";
...
ChiptuneJsPlayer.prototype.UTF8ToString = function (base, len) {
...
ChiptuneJsPlayer.prototype.play = function (buffer) {
  ...
  if (!processNode) {
    console.log("Erro na criação de node");
    return;
  }
